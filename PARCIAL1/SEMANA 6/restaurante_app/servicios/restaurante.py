...
class Restaurante:
    ...
    def __init__(self, nombre: str, direccion: str, telefono: str) -> None:
        ...
        self.productos: list = []  # Lista de productos disponibles
        self.clientes: list = []   # Lista de clientes registrados
        self.ordenes: list = []    # Lista de órdenes realizadas
        self.contador_ordenes: int = 0  # Contador para generar IDs de órdenes
    ...
    def crear_orden(self, cliente, productos_pedidos: list) -> int:
        ...
        numero_orden: int = self.contador_ordenes

        total: float = sum(producto.precio for producto in productos_pedidos)
